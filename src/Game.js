...
function Game() {
  ...
  const checkForRowOfFour = () => {
    for (let i = 0; i < 64; i++) {
      ...
      const notValid = [
        5, 13, 21, 29, 37, 45, 53, 62, 6, 7, 14, 15, 22, 23, 30, 31, 38, 39, 46,
        47, 54, 55, 63, 64,
      ];
      if (notValid.includes(i)) continue;
  ...
  useEffect(() => {
    if (score > 150) {
      setDancing(
        <img src={tiffi} style={{ height: "130px", width: "130px" }} />
      );
    } else {
      setDancing(null);
    }
  ...
  return (
    <div className="back">
      <div style={{ float: "right" }}>
        <img
          src="https://i.postimg.cc/LXpH96jN/candy-crush-soda-candy-crush.gif"
          style={{ height: "120px", width: "120px" ,marginRight:"16px"}}
        />
      </div>
      <div className="board">
        <audio autoPlay loop>
      ...
      <div style={{ marginBottom: "0px", height: "" }}>{dancing}</div>
    </div>
    //  </div>
  );
}
